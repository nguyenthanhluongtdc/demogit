...
switch (true) {
	case $_POST['action'] == "addtocart" && $_POST['id'] != "":
		...
		case $_POST['action'] == "addtocart2" && $_POST['id'] != "":

		if(intval($_POST['quantity']) <= 0)
			$_POST['quantity'] = 1;

		if(isset($_POST['color_id']) && !isset($_POST['size_id'])){
			// co color -> khong co size
			if(@$_SESSION['cart'][$_POST['id']][$_POST['color_id']]['size_undefined'] != "")
				$_SESSION['cart'][$_POST['id']][$_POST['color_id']]['size_undefined'] += intval($_POST['quantity']);
			else{
				$_SESSION['cart'][$_POST['id']][$_POST['color_id']][$_POST['size_id']] = intval($_POST['quantity']);
			}
		}else if( !isset($_POST['color_id'])  && isset($_POST['size_id'])) {
			//co size -> khong co color
			if(@$_SESSION['cart'][$_POST['id']]['color_undefined'][$_POST['size_id']] != "")
				$_SESSION['cart'][$_POST['id']]['color_undefined'][$_POST['size_id']] += intval($_POST['quantity']);
			else{
				$_SESSION['cart'][$_POST['id']][$_POST['color_id']][$_POST['size_id']] = intval($_POST['quantity']);
			}
		}else if(!isset($_POST['color_id'])  && !isset($_POST['size_id'])){
			//khong co ca hai
			if(@$_SESSION['cart'][$_POST['id']]['color_undefined']['size_undefined'] != "")
				$_SESSION['cart'][$_POST['id']]['color_undefined']['size_undefined'] += intval($_POST['quantity']);
			else{
				$_SESSION['cart'][$_POST['id']]['color_undefined']['size_undefined'] = intval($_POST['quantity']);
			}
		}else {
			...
			if(@$_SESSION['cart'][$_POST['id']][$_POST['color_id']][$_POST['size_id']] != "")
				$_SESSION['cart'][$_POST['id']][$_POST['color_id']][$_POST['size_id']] += intval($_POST['quantity']);
			else{
				$_SESSION['cart'][$_POST['id']][$_POST['color_id']][$_POST['size_id']] = intval($_POST['quantity']);
			}
	...
	case $_POST['action'] == "removefromcart" && $_POST['id'] != "":
		...
		unset($_SESSION['cart'][$_POST['id']][$_POST['color_id']][$_POST['size_id']]);
	...
	case $_POST['action'] == "updatefromcart" && $_POST['id'] != "" && ($_POST['quantity'] != "" || $_POST['color_id'] != ""):
		if(isset($_SESSION['cart'][$_POST['id']][$_POST['color_id']][$_POST['size_id']] )) {
			if($_POST['quantity'] != "")
				$_SESSION['cart'][$_POST['id']][$_POST['color_id']][$_POST['size_id']] = $_POST['quantity'];
			if($_POST['color_id'] != "")
				$_SESSION['cart_color'][$_POST['id']] = $_POST['color_id'];
		}
		else
